	...
	; HI-TECH C Compiler for PIC10/12/16 MCUs V9.71
	; Copyright (C) 1984-2010 HI-TECH Software
	;Licensed for evaluation purposes only.
	;This licence will expire on Sun, 07 Oct 2018
	...
	; Compiler options:
	;
	; -oTimer LED.cof -mTimer LED.map --summary=default --output=default \
	; Timer LED.p1 --chip=16F877A -P --runtime=default --opt=default \
